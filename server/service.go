...
func NewService(cfg *v1.ServerConfig) (*Service, error) {
	...
	if cfg.Socks5ProxyPort > 0 {
		...
		svr.socks5Handler = socks5proxy.NewSOCKS5Handler(l, cfg.Socks5ProxyAuthPassword, svr.makeSelectFrpcFn(), svr.connTracker, cfg.MaxProxyConnections)
	...
	if cfg.HTTPConnectProxyPort > 0 {
		...
		svr.httpConnectHandler = socks5proxy.NewHTTPConnectHandler(l, cfg.HTTPConnectProxyAuthPassword, svr.makeSelectFrpcFn(), svr.connTracker, cfg.MaxProxyConnections)
